...
# 3 "main.c" 2
# 1 "Swc_2/include/Actuator_Swc_Rte.h" 1
# 1 "Include/Rte_Type.h" 1
...
typedef unsigned char Std_ReturnType;
# 2 "Swc_1/include/Sensor_Swc_Rte.h" 2

extern void Get_temp_operation(Sensor mySensor,float64 *Sens_Level);


extern void sensor_Swc_Init(void);
# 5 "main.c" 2


int main(){
    float64 Sens_Level = 0.0;
    Actuator_runn();
}
